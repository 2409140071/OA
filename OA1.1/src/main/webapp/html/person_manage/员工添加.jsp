...
<head>
    ...
    <script type="text/javascript" language="JavaScript1.2" src="${pageContext.request.contextPath}/js/stm31.js"></script>
    <script>
...
<form method="post" action="${pageContext.request.contextPath}/users/adduser.do">
    <center>
            ...
            <tr>
                <td height="25" align="center" valign="bottom" class="td06"> <table width="100%"  border="0" align="center" cellpadding="0" cellspacing="0">
                    <tr>
                        ...
                        <td height="30" valign="middle" background="${pageContext.request.contextPath}/images/bg_03.gif"><div align="left"><font color="#FFFFFF">员工添加</font></div></td>
                    </tr>
                </table></td>
            </tr>
        </table>
        ...
        <tr>
            ...
            <td width="40%" height="30"><input name="worktime" type="text" class="input" style="width:95% "></td>
            <td width="10%"   align="left">&nbsp;</td>
            <td width="40%">*验证账号是否存在</td>
        </tr>
        <tr>
            <td width="10%" height="30" align="left">员工姓名</td>
            <td width="40%" height="30"><input name="username" type="text" class="input" style="width:95% "></td>
            <td width="10%"   align="left">性&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;别</td>
            <td width="40%"><select name="sex" size="1" class="box" style="width:95%">
        ...
        <tr>
            ...
            <td width="40%" height="30"><input name="nickname" type="text" class="input" style="width:95% "></td>
            <td width="10%" align="left">登陆密码</td>
            <td width="40%" valign="middle"><input name="password" type="password" class="input" style="width:95% ">
            </td>
        </tr>
        <tr>
            <td width="10%" height="30" align="left"> 所属部门</td>
            <td width="40%" height="30"><font>
                <select name="depid" size="1" class="box" style="width:95%">
                    <option value="1" selected>财务部　　　　　　　　　　　　　</option>
                    <option value="2">市场部　　　　　　　　　　　　</option>
                </select>
            </font></td>
            <td width="10%" align="left"> 职 &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;务</td>
            <td width="40%" valign="middle"><select name="duty" size="1" class="box" style="width:95%">
        ...
        <tr>
            ...
            <td width="40%" height="30"><font>
                <input name="email" type="text" class="input" style="width:95% ">
            </font></td>
            <td width="10%" align="left">移动电话</td>
            <td width="40%" valign="middle"><input name="mobile" type="text" class="input" style="width:95% ">
            </td>
        </tr>
        <tr>
            <td width="10%" height="30" align="left">家庭电话</td>
            <td width="40%" height="30"><font>
                <input name="homephone" type="text" class="input" style="width:95% ">
            </font></td>
            <td width="10%" align="left">办公电话</td>
            <td width="40%" valign="middle"><input name="workphone" type="text" class="input" style="width:95% ">
            </td>
        </tr>
        <tr>
            <td width="10%" height="30" align="left">传真号码</td>
            <td width="40%" height="30"><font>
                <input name="fax" type="text" class="input" style="width:95% ">
            </font></td>
            <td width="10%" align="left">MSN</td>
            <td width="40%" valign="middle"><input name="MSN" type="text" class="input" style="width:95% ">
            </td>
        </tr>
        <tr>
            <td width="10%" height="30" align="left"> 生日</td>
            <td width="40%" height="30"><font>
                <input name="birthday" type="text" class="input" style="width:95% ">
            </font></td>
            <td width="10%" align="left"> 个人主页</td>
            <td width="40%" valign="middle"><input name="httpaddress" type="text" class="input" style="width:95% ">
            </td>
        </tr>
        <tr>
            <td height="30" colspan="4" align="left"> <font>&nbsp; </font>
                <table width="100%"  border="0" cellspacing="0" cellpadding="0">
                    <tr>
                        <td width="10%">通讯地址</td>
                        <td><font>
                            <input name="address" type="text" class="input" style="width:98% ">
                        </font></td>
                    </tr>
                </table>
            </td>
        ...
        <tr>
            <td colspan="4" align="left"><table width="100%"  border="0" cellspacing="0" cellpadding="0">
                <tr>
                    <td width="10%">备注</td>
                    <td><textarea name="content" rows="5" class="box"style="width:98% "></textarea></td>
                </tr>
            </table></td>
        </tr>
